 ...
 * @author juan
 */
public class Load_files extends JInternalFrame {
...
//                 0,
         ...
         for(int i=0;i<informationStored.length;i++){
             ...
             if(i==0){
                 ...
                 name_column="% : ";
                     ...
                     name_column="Txt source: ";
            }
            else{
                name_column="Comments : ";
            }
             txt+=name_column+informationStored[i]+"\n";
         }
    ...
    private File escogerArchivos() {
      //  JFileChooser selectorArchivo = new JFileChooser();
        JFileChooser selectorArchivo = new JFileChooser("C:\\Users\\juan\\Desktop\\UV\\TG\\complete100_sequences");
        FileNameExtensionFilter filtro = new FileNameExtensionFilter("Text files", "fasta");
